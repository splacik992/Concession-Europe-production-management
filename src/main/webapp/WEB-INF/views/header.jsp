...
<head>
    ...
    <title>ConcessionEurope</title>
    <!-- Custom fonts for this template -->
    <link rel="stylesheet" href="<c:url value="https://use.fontawesome.com/releases/v5.0.7/css/all.css"/>">
    <link rel="icon" href="<c:url value="/theme/img/favicon.ico"/>" type="image/x-icon">
    <link rel="shortcut icon" href="<c:url value="/theme/img/favicon.ico"/>" type="image/x-icon">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
            ...
            <div class="sidebar-brand-text mx-3">Concession Europe</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/transport">Transport</a>
